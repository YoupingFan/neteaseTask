(function(w,d,u){
	...
	var summary = form['goods_abstract'];
    ...
    if (goods == null) {
            ...
            initForm(JSON.parse(goods));
    }
    function initForm(goods) {
        var data = goods[goodsId];
        title.value = data.title;
        summary.value = data.goods_abstract;
			...
			form.addEventListener('submit',function(e){
				if(!isSubmiting && this.check()){
					var form_data = {
                	    ...
                	    'goods_abstract' : form['goods_abstract'].value,
